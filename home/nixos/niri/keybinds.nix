...
in
{
  programs.niri.settings.binds = {
    ...
    # Launch yazi file manager in terminal
    "Mod+E".action.spawn = [
      "${ghostty.packages.${pkgs.system}.default}/bin/ghostty"
      "-e"
      "yazi"
    ...
    # GUI Volume control (Wayland-native pwvucontrol) - simple direct launch
    "Mod+Alt+V".action.spawn = [ "pwvucontrol" ];

    # Terminal volume control (moved to avoid conflict)
    ...
    # Force-kill stubborn applications that don't respond to close-window
    ...
    # Screenshot with swappy editing
    "Print" = {
    ...
    # Window-specific screenshot with swappy
    "Shift+Print" = {
      allow-inhibiting = false;
      action.spawn = [
        "sh"
    ...
    # Quick screenshot to clipboard (no editing)
    "Alt+Print" = {
      allow-inhibiting = false;
      action.spawn = [
        "sh"
