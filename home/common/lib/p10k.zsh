# Generated by Powerlevel10k configuration wizard on 2025-06-23 at 15:05 BST.
...
() {
  ...
  # Set to quiet to suppress warnings from direnv/devenv output during initialization
