...
let
  ...
  # Theming - provided by Signal flake's homeManagerModule
  # Signal's module exports signalPalette, signalLib, and signalColors via _module.args
  # Do not override them here - let Signal provide the theme
in
{
  ...
  # Note: signalPalette, signalLib, and signalColors are provided by Signal's homeManagerModule
  _module.args = {
    inherit
      hosts
      hostsConfig
