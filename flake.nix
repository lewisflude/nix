{
  ...
  nixConfig = {
    ...
    extra-substituters = [
      ...
      "https://chaotic-nyx.cachix.org?priority=4"
      "https://nixpkgs-python.cachix.org?priority=5"
      "https://lewisflude.cachix.org?priority=6"
      "https://niri.cachix.org?priority=7"
      "https://ghostty.cachix.org?priority=8"
      "https://yazi.cachix.org?priority=9"
      "https://ags.cachix.org?priority=10"
      "https://zed.cachix.org?priority=11"
      "https://catppuccin.cachix.org?priority=12"
      "https://devenv.cachix.org?priority=13"
      "https://viperml.cachix.org?priority=14"
      "https://cuda-maintainers.cachix.org?priority=15"
    ];
