...
mkMerge [
  ...
  {
    options.host.services.mediaManagement.qbittorrent = import ./webui.nix { inherit lib constants; };
  }
  {
    options.host.services.mediaManagement.qbittorrent = import ./bittorrent.nix { inherit lib; };
  }
  {
    options.host.services.mediaManagement.qbittorrent = import ./performance.nix { inherit lib; };
  }
]
