  ...
  flake.modules.homeManager.claudeCode = { lib, pkgs, config, ... }: {
    programs.claude-code = {
      ...
      settings = {
        ...
        autoApprove = { readOperations = true; writeOperations = false; };
        session = { maxTurns = -1; saveHistory = true; };
        context = { loadProjectContext = true; contextFiles = [ "CLAUDE.md" "CONVENTIONS.md" "README.md" ]; };
