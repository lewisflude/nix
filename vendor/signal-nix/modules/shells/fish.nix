...
let
  ...
  # Fish uses terminal ANSI colors that are themed by Signal
  colors = {
  ...
  config = mkIf (cfg.enable && shouldTheme) {
    programs.fish.shellInit =
      ...
      ''
        ...
        set -g fish_color_escape ${toFishColor categorical.${themeMode}."data-viz-08"}
        ...
        set -g fish_pager_color_selected_description ${toFishColor text-secondary}
        set -g fish_pager_color_secondary_background
        set -g fish_pager_color_secondary_prefix ${toFishColor accent.secondary.Lc75}
        set -g fish_pager_color_secondary_completion ${toFishColor text-secondary}
